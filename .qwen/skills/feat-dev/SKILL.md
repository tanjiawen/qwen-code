...
blueprint:
  ...
  steps:
    - description: 'Grill-me: interview the user to reach a shared design concept; do not start on a vague idea'
      tool: 'agent'
    - description: 'Read or create GLOSSARY.md and use canonical terms'
      tool: 'read_file'
      requires: 'Shared design concept confirmed'
